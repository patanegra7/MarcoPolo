 ...
 * Use the {@link ConceptPieCharDialogFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ConceptPieCharDialogFragment extends DialogFragment {
     ...
     * Default constructor
     */
    public ConceptPieCharDialogFragment() {
        super();
    }
    ...
    public static ConceptPieCharDialogFragment newInstance(Map<String, Float> percentages, Currency currency) {
        ConceptPieCharDialogFragment fragment = new ConceptPieCharDialogFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        getDialog().setTitle(R.string.summary_concept_percentages_chart_title);
        return view;
