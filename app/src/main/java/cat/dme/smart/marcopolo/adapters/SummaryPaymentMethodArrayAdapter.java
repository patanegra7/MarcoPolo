 ...
 */
public class SummaryPaymentMethodArrayAdapter extends ArrayAdapter<Expense> {

    public SummaryPaymentMethodArrayAdapter(Context context, List<Expense> expenses) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView = LayoutInflater.from(this.getContext()).inflate(R.layout.list_summary_payment_methods, parent, false);

        if(expense.getPaymentMethod()!=null) {
            TextView tvPaymentMethod = (TextView) convertView.findViewById(R.id.summary_payment_method_name);
            tvPaymentMethod.setText(expense.getPaymentMethod().getName());
        }
