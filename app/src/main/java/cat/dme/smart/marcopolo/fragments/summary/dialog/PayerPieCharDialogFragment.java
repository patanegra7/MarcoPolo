 ...
 * Use the {@link PayerPieCharDialogFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class PayerPieCharDialogFragment extends DialogFragment {
     ...
     * Default constructor
     */
    public PayerPieCharDialogFragment() {
        super();
    }
    ...
    public static PayerPieCharDialogFragment newInstance(Map<String, Float> percentages, Currency currency) {
        PayerPieCharDialogFragment fragment = new PayerPieCharDialogFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        getDialog().setTitle(R.string.summary_payer_percentages_chart_title);
        return view;
