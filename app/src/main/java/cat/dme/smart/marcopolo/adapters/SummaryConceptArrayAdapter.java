 ...
 */
public class SummaryConceptArrayAdapter extends ArrayAdapter<Expense> {

    public SummaryConceptArrayAdapter(Context context, List<Expense> expenses) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView = LayoutInflater.from(this.getContext()).inflate(R.layout.list_summary_concepts, parent, false);

        if(expense.getConcept()!=null) {
            TextView tvConcept = (TextView) convertView.findViewById(R.id.summary_concept_name);
