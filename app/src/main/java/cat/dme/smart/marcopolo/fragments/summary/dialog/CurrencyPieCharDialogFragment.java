 ...
 * Use the {@link CurrencyPieCharDialogFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class CurrencyPieCharDialogFragment extends DialogFragment {

    private static final String ARG_PARAM1 = "currencyPercentages";
     ...
     * Default constructor
     */
    public CurrencyPieCharDialogFragment() {
        super();
    }
    ...
    public static CurrencyPieCharDialogFragment newInstance(Map<String, Float> percentages, Currency currency) {
        CurrencyPieCharDialogFragment fragment = new CurrencyPieCharDialogFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        getDialog().setTitle(R.string.summary_currency_percentages_chart_title);
        return view;
